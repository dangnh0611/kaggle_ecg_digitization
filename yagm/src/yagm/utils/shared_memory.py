# ref: https://github.com/python/cpython/blob/8ecb8962e33930dd56d72004a59336d4b00fce22/Lib/multiprocessing/shared_memory.py
# this patch is to support track=False feature on older version of Python3
# Related:
#   - https://github.com/python/cpython/issues/116849
