...
# Ref: https://github.com/microsoft/CSWin-Transformer/blob/main/segmentation/backbone/cswin_transformer.py
...
class LePEAttention(nn.Module):
    ...
    def get_rpe(self, x, func):
        ...
        rpe = func(x)  ### B', C, H', W'
        rpe = (
            rpe.reshape(-1, self.num_heads, C // self.num_heads, H_sp * W_sp)
            .permute(0, 1, 3, 2)
            .contiguous()
        )
...
class CSWinTransformer(nn.Module):
    ...
    def __init__(
        ...
        if mean is not None or std is not None:
            ...
            logger.info(
                "CSWin Transformer normalization using\nMEAN=%s\nSTD=%s\n", mean, std
            )
        ...
        self._output_channels = [in_chans, embed_dim]
        curr_dim = embed_dim
        dpr = [
        ...
        self._output_channels.append(curr_dim)
